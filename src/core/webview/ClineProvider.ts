	...
	*/
	...
	async getStateToPostToWebview() {
		...
		return {
			...
			alwaysAllowNotebookRead: alwaysAllowNotebookRead ?? false,
			alwaysAllowNotebookEdit: alwaysAllowNotebookEdit ?? false,
			alwaysAllowNotebookExecute: alwaysAllowNotebookExecute ?? false,
			...
			notebookMaxOutputSize: notebookMaxOutputSize ?? 2000,
			notebookTimeoutSeconds: notebookTimeoutSeconds ?? 30,
	...
	async getState() {
		...
		return {
			...
			alwaysAllowNotebookRead: stateValues.alwaysAllowNotebookRead ?? false,
			alwaysAllowNotebookEdit: stateValues.alwaysAllowNotebookEdit ?? false,
			alwaysAllowNotebookExecute: stateValues.alwaysAllowNotebookExecute ?? false,
			...
			notebookMaxOutputSize: stateValues.notebookMaxOutputSize ?? 2000,
			notebookTimeoutSeconds: stateValues.notebookTimeoutSeconds ?? 30,
