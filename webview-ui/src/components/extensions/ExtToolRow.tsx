...
type ExtToolRowProps = {
	tool: ExtTool
	extensionId?: string
	alwaysAllowExtTools?: boolean
}

const ExtToolRow = ({ tool, extensionId, alwaysAllowExtTools }: ExtToolRowProps) => {
	const { t } = useAppTranslation()

	const handleAlwaysAllowChange = () => {
		if (!extensionId) return
		vscode.postMessage({
			type: "toggleExtToolAlwaysAllow",
			extensionId,
			toolName: tool.name,
	...
	return (
		<div
			...
			<div
				data-testid="ext-tool-row-container"
				...
				{extensionId && alwaysAllowExtTools && (
